...
mpicxx -o test_cpp test_tp3.o  -L/scratch/globc/ferrario/last_trunk/build_ifort_CERFACS_prod/lib -L/softs/local_intel/netcdf/4.4.4_phdf5_1.10.4/lib -L/softs/local_intel/phdf5/1.10.4_impi/lib -L/scratch/globc/ferrario/oasis3-mct/INSTALL_OASIS.kraken_intel23.2.1_intelmpi2021.10.0/lib -lnetcdff -lnetcdf -lgfortran  -lxios 
